...
Feature: Automated the your logo page
  ...
  Scenario: choose a product and it is displayed in the shopping cart successfully
    ...
    When  I look for 'dress' and select any displayed result
    And I add '2' products to go to the shopping cart
    Then  should the shopping cart show the product amount '2'
